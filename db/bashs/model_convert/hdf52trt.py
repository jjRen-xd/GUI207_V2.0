...
def convert_hdf5_to_trt(dfPath, pbPath="./temp.pb", oxPath="./temp.onnx", trtPath="./temp.trt", workspace=3072, optBatch=20, maxBatch=100):
    try:
        ...
        " --optShapes=Input:0:"+optBatch+"x"+inputShape+" --maxShapes=Input:0:"+maxBatch+"x"+inputShape+" --fp16")
