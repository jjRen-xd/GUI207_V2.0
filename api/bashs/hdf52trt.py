...
def convert_hdf5_to_trt(model_type, work_dir, model_name, workspace='3072', optBatch='20', maxBatch='100'):
    if model_type=='HRRP':
        hdfPath = work_dir+"/model/"+model_name+".hdf5"
    elif model_type=='AFS':
        hdfPath = work_dir+"/model/"+model_name+"_feature_39.hdf5"
...
if __name__ == '__main__':
    ...
    convert_hdf5_to_trt(args.model_type, args.work_dir, args.model_name)