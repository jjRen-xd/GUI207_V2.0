...
QRibbon::QRibbon(): QMenuBar(), _(new QRibbonPrivate(this)){
    ui = new Ui::QRibbon();
    ui->setupUi(this);
    ...
    styleActionGroup->addAction(_styleMenu->addAction("浅蓝色", [&]()
    {
        setColor("rgb(120, 170, 220)");
    }));
    styleActionGroup->addAction(_styleMenu->addAction("黑色", [&]()
    {
        setColor("rgb(0, 0, 0)");
    }));
